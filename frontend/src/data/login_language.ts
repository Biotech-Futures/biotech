...
export const LOGIN_MESSAGES = {
  ...
  'zh-CN': {
    ...
    digit: '第',
    codeExpiryHint:
      '验证码仅可使用一次，有效期为 10 分钟。重新发送的是同一个验证码，因此任何一封邮件都可以使用。',
    codeExpiresIn: '验证码将在以下时间后失效：',
    codeExpiredHint: '验证码已失效，请重新获取。',
    codeSpamHint: '没有收到？请检查垃圾邮件文件夹。',
    confirmTitle: '确认登录',
    confirmBody: '点击继续，以此身份完成登录：',
    confirmAction: '继续登录',
    confirmWorking: '正在为你登录…',
    needHelp: '需要帮助？',
    contactSupport: '联系支持',
    backToSignIn: '返回登录',
    accountInactiveTitle: '账户已停用',
    accountInactiveBody: '该账户已被暂停或停用，因此无法登录。需要由管理员重新启用后，你才能访问平台。',
    accountInactiveContact: '请发送邮件申请重新启用：',
  ...
  ja: {
    ...
    digit: '桁',
    codeExpiryHint:
      'コードは一度だけ使用でき、有効期限は10分です。再送信しても同じコードが届くため、どのメールのコードでも使用できます。',
    codeExpiresIn: 'このコードの有効期限:',
    codeExpiredHint: 'このコードは失効しました。新しいコードを取得してください。',
    codeSpamHint: '届きませんか？迷惑メールフォルダをご確認ください。',
    confirmTitle: 'ログインの確認',
    confirmBody: '「続行」を押して、次のアカウントでログインを完了してください:',
    confirmAction: '続行してログイン',
    confirmWorking: 'ログインしています…',
    needHelp: 'お困りですか？',
    contactSupport: 'サポートに連絡',
    backToSignIn: 'サインイン画面に戻る',
    accountInactiveTitle: 'アカウントが無効です',
    accountInactiveBody: 'このアカウントは停止または無効化されているため、サインインできません。ポータルを利用するには、管理者による再有効化が必要です。',
    accountInactiveContact: '再有効化のご依頼は、こちらまでメールしてください：',
  ...
  ko: {
    ...
    digit: '자리',
    codeExpiryHint:
      '코드는 1회용이며 10분 동안 유효합니다. 다시 보내도 같은 코드가 전송되므로 어떤 이메일의 코드든 사용할 수 있습니다.',
    codeExpiresIn: '코드 만료까지',
    codeExpiredHint: '코드가 만료되었습니다. 새 코드를 요청하세요.',
    codeSpamHint: '받지 못하셨나요? 스팸함을 확인해 주세요.',
    confirmTitle: '로그인 확인',
    confirmBody: '계속을 눌러 다음 계정으로 로그인을 완료하세요:',
    confirmAction: '계속해서 로그인',
    confirmWorking: '로그인 중입니다...',
    needHelp: '도움이 필요하신가요?',
    contactSupport: '지원 문의',
    backToSignIn: '로그인 화면으로 돌아가기',
    accountInactiveTitle: '비활성화된 계정',
    accountInactiveBody: '이 계정은 정지되었거나 비활성화되어 로그인할 수 없습니다. 포털을 이용하려면 관리자가 계정을 다시 활성화해야 합니다.',
    accountInactiveContact: '재활성화를 요청하려면 아래 주소로 메일을 보내주세요:',
  ...
  ar: {
    ...
    digit: 'الخانة',
    codeExpiryHint:
      'الرموز للاستخدام مرة واحدة وتبقى صالحة لمدة 10 دقائق. إعادة الإرسال ترسل الرمز نفسه، لذا يصلح أي من هذه الرسائل.',
    codeExpiresIn: 'تنتهي صلاحية هذا الرمز خلال',
    codeExpiredHint: 'انتهت صلاحية هذا الرمز. اطلب رمزًا جديدًا.',
    codeSpamHint: 'لم يصلك الرمز؟ تحقق من مجلد الرسائل غير المرغوب فيها.',
    confirmTitle: 'تأكيد تسجيل الدخول',
    confirmAction: 'متابعة تسجيل الدخول',
    confirmBody: 'اضغط على متابعة لإكمال تسجيل الدخول باسم',
    confirmWorking: 'جارٍ تسجيل دخولك...',
    needHelp: 'هل تحتاج إلى مساعدة؟',
    contactSupport: 'التواصل مع الدعم',
    backToSignIn: 'العودة إلى تسجيل الدخول',
    accountInactiveTitle: 'الحساب غير مفعّل',
    accountInactiveBody: 'تم تعليق هذا الحساب أو إلغاء تفعيله، لذلك لا يمكن استخدامه لتسجيل الدخول. يجب على المسؤول إعادة تفعيله قبل أن تتمكن من الوصول إلى البوابة.',
    accountInactiveContact: 'راسلنا عبر البريد الإلكتروني لطلب إعادة التفعيل:',
